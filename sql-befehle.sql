...
CREATE TABLE adresse (
    ...
    FOREIGN KEY (Postleitzahl) REFERENCES ort(Postleitzahl) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE arbeitgeber (
    ...
    FOREIGN KEY (AdressId) REFERENCES adresse(AdressId) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE arbeitsverhaeltnisse (
    ...
    FOREIGN KEY (VersicherungsNr) REFERENCES versicherter(VersicherungsNr) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (ArbeitgeberId) REFERENCES arbeitgeber(ArbeitgeberId) ON DELETE CASCADE ON UPDATE CASCADE
);
